...
/**
 Base class for all bialikapp views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the bialikapp view hierarchy (such as wrapped iOS UIViews) was touched.
