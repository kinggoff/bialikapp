...
//@interface bialikappObject : NSObject
//@end

@interface bialikappObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[bialikappObject class]])
		{
			for (NSString *key in [[(bialikappObject*)o modules] allKeys])
			{
