...
@interface bialikappObject : KrollCoverageObject {
#else
@interface bialikappObject : KrollObject {
#endif
@private
...
extern NSString * bialikapp$ModuleRequireFormat;
