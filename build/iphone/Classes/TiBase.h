...
// in simulator we redefine to format for bialikapp Developer console
...
{\
	NSString * exceptionName = [@"org.bialikapp." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.bialikapp";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIbialikappNativeItemNone = -1, 
	UIbialikappNativeItemSpinner = -2,
	UIbialikappNativeItemProgressBar = -3,
	
	UIbialikappNativeItemSlider = -4,
	UIbialikappNativeItemSwitch = -5,
	UIbialikappNativeItemMultiButton = -6,
	UIbialikappNativeItemSegmented = -7,
	
	UIbialikappNativeItemTextView = -8,
	UIbialikappNativeItemTextField = -9,
	UIbialikappNativeItemSearchBar = -10,
	
	UIbialikappNativeItemPicker = -11,
	UIbialikappNativeItemDatePicker = -12,
	
	UIbialikappNativeItemInfoLight = -13,
	UIbialikappNativeItemInfoDark = -14,
	
	UIbialikappNativeItemDisclosure = -15,
	
	UIbialikappNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all bialikapp instances of
